...
public class Longest_Substring_Without_Repeat {
    ...
    public static void Testing() {
    	Assert.assertEquals(11,lengthOfLongestSubstring("My#Name?is Neelam Sharma") );
    	Assert.assertEquals(1,lengthOfLongestSubstring("aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa"));
    	Assert.assertEquals(4,lengthOfLongestSubstring("abcdcba"));
    	Assert.assertEquals(5,lengthOfLongestSubstring("pqrsqpsrt"));
    	Assert.assertEquals(4,lengthOfLongestSubstring("malyalam"));
